...
<head>
    <meta charset="UTF-8"/>
    <title>Gold Wing Hospitality - Ultimate Booking System</title>
...
<!--<img src="<?php /*echo $url . '/img/footer-corrner.png'; */?>" class="footer-corrner"/>-->
    <div class="container">
        <h3>Creating your own Booking<br />System with <span>Gold Wing Hospitality</span> is super<br />fast and easy <img src="{{url('landing/img/hand.svg')}}" /></h3>
