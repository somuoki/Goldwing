...
<head>
    ...
    <title>{{ $page_title ?? 'Dashboard'}} - {{setting_item('site_title') ?? 'Gold Wing Hospitality'}}</title>
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-6 copy-right" >
                        {{date('Y')}} &copy; {{__('Gold Wing Hospitality by')}} <a href="{{__('https://www.credevart.com')}}" target="_blank">{{__('CREDEVART')}}</a>
                    </div>
                    <div class="col-md-6">
