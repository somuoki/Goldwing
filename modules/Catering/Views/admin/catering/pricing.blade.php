    ...
    <div class="panel-body">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="form-group">
                        ...
                        <input type="number" step="any" min="0" name="number" class="form-control" value="{{$row->number}}" placeholder="{{__("Number Of Catering Equipment")}}">
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="form-group">
                        <label class="control-label">{{__("Price")}}</label>
                        <input type="number" step="any" min="0" name="price" class="form-control" value="{{$row->price}}" placeholder="{{__("Catering Equipment Price")}}">
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="form-group">
                        <label class="control-label">{{__("Sale Price")}}</label>
                        <input type="number" step="any" name="sale_price" class="form-control" value="{{$row->sale_price}}" placeholder="{{__("Catering Equipment Sale Price")}}">
        ...
        @if(is_default_lang())
            <div class="row">
                ...
                <div class="col-lg-6">
                    <div class="form-group">
                        <label class="control-label">{{__("Minimum day lease requirements")}}</label>
                        <input type="number" name="min_day_stays" class="form-control" value="{{$row->min_day_stays}}" placeholder="{{__("Ex: 2")}}">
                        <i>{{ __("Leave blank if you dont need to set minimum day lease option") }}</i>
                    </div>
                </div>
            </div>
        @endif
        ...
        @if(is_default_lang() and (!empty(setting_item("catering_allow_vendor_can_add_service_fee")) or is_admin()))
            <hr>
