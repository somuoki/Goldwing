<?php
/**
 * @var $translation \Modules\Catering\Models\CateringTranslation
 * @var $row \Modules\Catering\Models\Catering
 */
?>
<div class="g-header">
    <div class="left">
...
@endif
@include('Catering::frontend.layouts.details.attributes')
@if($translation->faqs)
<div class="g-faq">
    <h3> {{__("FAQs")}} </h3>
